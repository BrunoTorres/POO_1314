...
public class LoginForm extends javax.swing.JFrame {
	...
	public LoginForm() {
		...
		try {
			...
			u1.addActivity(new Running("Corrida", new GregorianCalendar(), 300, 10, "Chuva"), "Running");
			u1.addActivity(new MountainBiking("BTT", new GregorianCalendar(), 400, 10, 0.001, "Sol"), "MountainBiking");
			...
			u3.addActivity(new Running("Corrida1", new GregorianCalendar(), 60,	7, "Sol"), "Running");
			u3.addActivity(new Running("Corrida2", new GregorianCalendar(), 71, 9, "Chuva"), "Running");
			u3.addActivity(new MountainBiking("BTT", new GregorianCalendar(), 300, 10, 0.040, "Sol"), "MountainBiking");
			u4.addActivity(new Running("Corrida1", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u4.addActivity(new Running("Corrida2", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u4.addActivity(new Running("Corrida3", new GregorianCalendar(), 90, 84, "Sol"), "Running");
			u4.addActivity(new Running("Corrida4", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u4.addActivity(new Running("Corrida5", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u4.addActivity(new Running("Corrida6", new GregorianCalendar(), 90, 84, "Sol"), "Running");
			u4.addActivity(new MountainBiking("BTT", new GregorianCalendar(), 400, 10, 1.2, "Sol"), "MountainBiking");
			u4.addActivity(new Orienteering("Orienta", new GregorianCalendar(), 190, 150, "Sol"), "Orienteering");
			u5.addActivity(new Running("Corrida1", new GregorianCalendar(), 90, 10, "Sol"), "Running");
			u5.addActivity(new Running("Corrida2", new GregorianCalendar(), 100, 11, "Chuva"), "Running");
			u5.addActivity(new Running("Corrida3", new GregorianCalendar(), 70, 7, "Sol"), "Running");
			...
			u6.addActivity(new Running("Corrida3", new GregorianCalendar(), 90, 9, "Sol"), "Running");
			u6.addActivity(new MountainBiking("BTT", new GregorianCalendar(), 200, 19, 0.070, "Sol"), "MountainBiking");
			u6.addActivity(new Yoga("Yoga", new GregorianCalendar(), 50), "Yoga");
			u7.addActivity(new Running("Corrida", new GregorianCalendar(), 300, 13, "Chuva"), "Running");
			u7.addActivity(new MountainBiking("BTT", new GregorianCalendar(), 400, 14, 0.003, "Sol"), "MountainBiking");
			u8.addActivity(new Running("Corrida1", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u8.addActivity(new Running("Corrida2", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u8.addActivity(new Running("Corrida3", new GregorianCalendar(), 90, 84, "Sol"), "Running");
			u8.addActivity(new Running("Corrida4", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u8.addActivity(new Running("Corrida5", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u8.addActivity(new Running("Corrida6", new GregorianCalendar(), 90, 84, "Sol"), "Running");
			u8.addActivity(new Football("Futebolada", new GregorianCalendar(), 90, 7, 0, "Sol"), "Football");
			u9.addActivity(new Running("Corrida1", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u9.addActivity(new Running("Corrida2", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u9.addActivity(new Running("Corrida3", new GregorianCalendar(), 90, 84, "Sol"), "Running");
			u9.addActivity(new Running("Corrida4", new GregorianCalendar(), 100, 75, "Sol"), "Running");
			u9.addActivity(new Running("Corrida5", new GregorianCalendar(), 120, 80, "Chuva"), "Running");
			u9.addActivity(new Running("Corrida6", new GregorianCalendar(), 90, 84, "Sol"), "Running");
